...
| 21 | `21-avisos-controles-y-herramientas.md` · avisos que no se activan (RV-81, RV-84, RV-86), controles del mapa (RV-82) y herramientas de Claude Code (SK-01 a SK-03), en tres sesiones | vivo |
