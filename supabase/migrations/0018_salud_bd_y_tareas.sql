-- 0018 · Salud del sistema (FR-143): tamaño de la base de datos, que comparte los 500 MB gratuitos
-- con uniformidad, y última ejecución de las tareas programadas, que escribe vigilancia.yml en
-- config.tareas_programadas (docs/17 RV-22, TR-53, TR-54). Misma firma.
