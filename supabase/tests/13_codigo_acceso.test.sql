...
select * from dblink('c1', format($q$select error from hidrantes.fn_verificar_codigo('000000', gen_random_uuid(), %L)$q$,
...
create temp table r2 as select * from dblink_get_result('c2') as t(e text);
